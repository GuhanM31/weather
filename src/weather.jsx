...
function Weather() {
    ...
    return (
        ...
        <div className="bg-blue-950 p-16 rounded-md   md:flex  gap-">
            ...
            <div className="l-screen bg-gradient-to-br from-blue-500 via-blue-600 to-pink-500  p-10 flex-grow border-y-white rounded-md m- md:my-20 ">
                ...
                <div className="flex flex-col">
                    <input  onChange={handlecity}  type="text" name="q" class="  border h-12 shadow p-4 rounded-full dark:text-gray-800 dark:border-gray-700 dark:bg-gray-200 my-4  w-full md:w-52" placeholder="search weather.....☾☼"></input>
